...
class MiApp:
    def __init__(self, root):
        ...
        self.canvas_height = 380  # Altura inicial de la ventana
        ...
        self.extremo_inferior_y = 350  # Coordenada y del extremo inferior fijo
        ...
        self.label_posicion.place(x=10, y=35)
        self.entry_posicion = tk.Entry(root)
        self.entry_posicion.place(x=150, y=35)

        self.label_volumen = tk.Label(root, text="Volumen:")
        self.label_volumen.place(x=10, y=65)
        self.entry_volumen = tk.Entry(root)
        self.entry_volumen.place(x=150, y=65)
